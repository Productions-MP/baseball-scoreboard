...
PRIMARY_RECOVERY_GRACE_SECONDS="${SCOREHLS_WIFI_PRIMARY_RECOVERY_GRACE_SECONDS:-180}"
PRIMARY_REBOOT_SECONDS="${SCOREHLS_WIFI_PRIMARY_REBOOT_SECONDS:-900}"
PRIMARY_REBOOT_MAX_SECONDS="${SCOREHLS_WIFI_PRIMARY_REBOOT_MAX_SECONDS:-21600}"
STATE_DIR="${SCOREHLS_WIFI_STATE_DIR:-/run/scorehls}"
STATE_FILE="${STATE_DIR}/wifi-failover-primary.state"
REBOOT_STATE_DIR="${SCOREHLS_WIFI_REBOOT_STATE_DIR:-/var/lib/scorehls}"
REBOOT_STATE_FILE="${REBOOT_STATE_DIR}/wifi-failover-primary-reboot-delay.state"
PRIMARY_CONN="scorehls-${USB_IFACE}"
FALLBACK_CONN="scorehls-${FALLBACK_IFACE}"
...
keys = [
    ...
    "SCOREHLS_WIFI_STATE_DIR",
    "SCOREHLS_WIFI_REBOOT_STATE_DIR",
]
...
PRIMARY_REBOOT_SECONDS="${SCOREHLS_WIFI_PRIMARY_REBOOT_SECONDS:-${PRIMARY_REBOOT_SECONDS}}"
PRIMARY_REBOOT_MAX_SECONDS="${SCOREHLS_WIFI_PRIMARY_REBOOT_MAX_SECONDS:-${PRIMARY_REBOOT_MAX_SECONDS}}"
REBOOT_STATE_DIR="${SCOREHLS_WIFI_REBOOT_STATE_DIR:-${REBOOT_STATE_DIR}}"
REBOOT_STATE_FILE="${REBOOT_STATE_DIR}/wifi-failover-primary-reboot-delay.state"
PRIMARY_CONN="scorehls-${USB_IFACE}"
FALLBACK_CONN="scorehls-${FALLBACK_IFACE}"

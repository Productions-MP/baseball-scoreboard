    ...
    def _build_views(self) -> list[ButtonView]:
        ...
        if self.page == "admin":
            views = [
                ...
                ButtonView("RESTART", "STACK", background=COLOR_WARNING, action="restart-scoreboard", requires_confirm=True),
                ButtonView("REBOOT", "PI", background=COLOR_DANGER, action="reboot-pi", requires_confirm=True),
                ButtonView("SHUTDOWN", "PI", background=COLOR_DANGER, action="shutdown-pi", requires_confirm=True),
